...
import { CATEGORIES, OCCASIONS, SHOPIFY_CACHE_KEY, filterProducts, getProducts, isInStock, productMetafields, provisionCatalog, shopifyFetch, shopifyHost } from './catalog.js';
...
export async function handleAdmin(
  ...
  path: string,
    ...
    if (path === '/admin/mapped' && request.method === 'GET') {
      ...
      if (url.searchParams.get('fresh') === '1') await getStore(env).delete(SHOPIFY_CACHE_KEY);
